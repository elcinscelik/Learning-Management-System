...
<div class="main">
  <h2>Syllabus &nbsp;&nbsp; <a href="syllabusup.php"><img src="img/edit.png" width="30px"</a></h2>
		<div class="contaier">
		<embed src="files/syllabus.pdf" type="application/pdf" width="100%" height="1920px" />
	</div>
<?php
$username = $_SESSION['un'];
echo "your name is " . $_SESSION["un"]
?>
</div>
